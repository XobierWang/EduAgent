...
def serialize_course_record(course_record: CourseRecord) -> dict:
    return {
        ...
        "case_code": course_record.case_code,
        "diagnosis": course_record.diagnosis,
        "chief_complaint": course_record.chief_complaint,
        "present_illness": course_record.present_illness,
        "past_history": course_record.past_history,
        "treatment_plan": course_record.treatment_plan,
        "attending_physician": course_record.attending_physician,
...
def serialize_learning_session(learning_session: LearningSession) -> dict:
    return {
        ...
        "visit_code": learning_session.visit_code,
        "visit_type": learning_session.visit_type,
        "department": learning_session.department,
        "physician_name": learning_session.physician_name,
        "visit_time": learning_session.visit_time.isoformat(),
